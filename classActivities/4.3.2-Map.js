...
const coords = data.map((user) => [user.address.geo.lat, user.address.geo.lng]);
console.log(coords);

// create an array of strings that combine the company's catchPhrase and bs
const companyJargon = data.map(
	(user) => `${user.company.catchPhrase} ${user.address.bs}`
);
console.log(companyJargon);
